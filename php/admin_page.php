...
<div class="card">
  <h5 class="card-header">Book Flights</h5>
  <div class="card-body">
    <h5 class="card-title">To book flights directly</h5>
    <a href="../booking.php" class="btn btn-primary">New Flight</a>
  </div>
</div>
...
<div class="card">
  <h5 class="card-header">Fill-up</h5>
  <div class="card-body">
    <h5 class="card-title">Search percentage of booked seats on a flight in a specific date</h5>
